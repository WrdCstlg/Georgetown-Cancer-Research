...
| A9 | **AlphaMissense cut-points.** AlphaMissense is now wired to its real published scores. Its publisher splits the 0–1 score at **< 0.34 = likely benign**, **> 0.564 = likely pathogenic**, **in between = ambiguous**. We transcribed those numbers exactly as published and have **not** altered them. Two things to confirm: (i) are the publisher's cut-points the right operating point for this study, or would you set them differently (a stricter pathogenic bar, a wider ambiguous band)? (ii) the publisher chose this split to reach roughly 90% precision **on a general population** — is that the right target here? *Worked example of why this matters:* PIK3CA **H1047R**, a textbook oncogenic hotspot, scores **0.5381** — just under the 0.564 line — so AlphaMissense reports it **ambiguous**, not pathogenic. Our tooling reports what the tool says, not what the literature expects; whether and how to close that gap is your call | |
